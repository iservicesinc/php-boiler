<div class="uk-flex uk-child-width-1-2@m" uk-grid>
    ...
    <div class="uk-flex uk-flex-column uk-flex-center uk-flex-first@m" uk-scrollspy="cls:uk-animation-slide-left;delay:100;repeat:true;">
        <h2 class="uk-heading-small">Simple <strong>PHP</strong> framework</h2>
...
<div class="uk-container uk-container-xsmall uk-margin-large-top">
    <p class="uk-text-lead uk-text-center">A very simple PHP framework to create web applications with routing and a Sass compiler. Extend applications with NPM package manager and Webpack. Default packages include <strong>sass</strong>, <strong>uikit</strong>, and <strong>webpack</strong>.</p>
    <h3>Requirements</h3>
    <ul>
        <li><a href="https://docs.docker.com/get-docker/" rel="nofollow norefferer noopener">Docker</a> (required for local development server)</li>
        <li><a href="https://nodejs.org/en/download/" rel="nofollow norefferer noopener">Node</a> (required for Webpack and Sass compiler)</li>
    </ul>
    <h3>Structure</h3>
    ...
    <p>The <code>src</code> folder is where all the magic happens! Create components to include/require throughout your project in the <code>src/html/components</code> directory, place your sites icons in the <code>src/html/icons</code> directory, add pages in the <code>src/html/pages</code> directory, store images in the <code>src/html/static/images</code> directory, customize your styles in <code>src/sass/main.scss</code>, and add any necessary javascript functions in <code>src/app.js</code>.</p>
